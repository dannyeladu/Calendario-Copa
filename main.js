...
`
btnThemePassion = document.querySelector(".btn-theme-passion")
  btnThemeMesagt = document.querySelector(".btn-theme-mesagt")
  btnThemePngtree = document.querySelector(".btn-theme-pngtree")
  btnThemeShading = document.querySelector(".btn-theme-shading")
  btnThemeWorld = document.querySelector(".btn-theme-world")
  btnThemeFootball = document.querySelector(".btn-theme-football")
  btnThemeTaca = document.querySelector(".btn-theme-taca")

  btnThemePassion.addEventListener("click", () => {
    document.body.className = "passion"
  })

  btnThemeMesagt.addEventListener("click", () => {
    document.body.className = "mesagt"
  })

  btnThemePngtree.addEventListener("click", () => {
    document.body.className = "pngtree"
  })

  btnThemeShading.addEventListener("click", () => {
    document.body.className = "shading"
  })

  btnThemeWorld.addEventListener("click", () => {
    document.body.className = "world"
  })

  btnThemeFootball.addEventListener("click", () => {
    document.body.className = "football"
  })

  btnThemeTaca.addEventListener("click", () => {
    document.body.className = "taca"
  })